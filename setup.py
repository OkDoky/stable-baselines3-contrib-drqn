...
with open(os.path.join("sb3_contrib_drqn", "version.txt" )) as file_handler:
...
setup(
    ...
    author="OkDoky",
    url="https://github.com/OkDoky/stable-baselines3-contrib-drqn",
    author_email="ie5630jk@gamil.com",
    keywords="reinforcement-learning-algorithms reinforcement-learning drqn recurrent dqn "
